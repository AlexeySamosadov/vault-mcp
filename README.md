...
| [vaultcolor-mcp](https://github.com/AlexeySamosadov/vaultcolor-mcp) | Color: hex/rgb/hsl convert, WCAG contrast · *Pro:* palette, mix | `npx github:AlexeySamosadov/vaultcolor-mcp` |
